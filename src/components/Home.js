...
const Home = () => (
  <HomeContainer>
    ...
    <p>If you click the "Explore" link above, you can view an array of popular movies. You can click "next page" or click the exact page your would like to see.
    ...
    I did this with setTimeout(). If no results turn up, it will say "No results found."</p>
    ...
    <p>
      ...
      I used the 'styled-components' for my styling, and created my own Backbutton component, which pass this.context.router.history.goBack() to an onClick event to return to the previous page.
    </p>
